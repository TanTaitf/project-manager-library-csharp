   ...
   public class BUS_Phieu
    {
       ...
       public void ChinhSuaCTPhieuTra(string maCTPT, string maPhieuTra, string maPhieuMuon, string maTaiLieuCu, string maTaiLieu)
       {
           dal_PhieuTra.ChinhSuaCTPhieuTra(maCTPT, maPhieuTra, maPhieuMuon, maTaiLieuCu, maTaiLieu);
       }
