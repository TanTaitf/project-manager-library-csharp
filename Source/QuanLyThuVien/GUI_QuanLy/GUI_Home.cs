...
namespace GUI_QuanLy
{
    ...
    public partial class GUI_Home : Form
    {
        ...
        public Panel Panel_Current = null;
        public string pathReport = @"C:\\Users\\Windows 8.1 Ultimate\\Desktop\\DOAN\\QuanLyThuVien\\GUI_QuanLy\\";
        /*
        ...
        void Add_IconTab()
        {
            ...
            tbcQuanTriAdmin.TabPages[2].ImageIndex = 2;
        ...
        */
        ...
        private void btnDocGia_Click(object sender, EventArgs e)
        {
            ...
            animator4.HideSync(Panel_Current);                     
            animator4.ShowSync(panelDocGia);
            Panel_Current = panelDocGia;
        ...
        */
        ...
        private void btnCapNhatNhanVien_Click(object sender, EventArgs e)
        {
            ...
            if (txtMatKhauNVCapNhat.TextLength < 8)
            {
                MessageBox.Show("Mật khẩu Phải Đủ 8 Ký Tự Trở Lên !");
                return;
            }
                ...
                && txtCaTrucNVCapNhat.Text != "")
            {
                if (Quyen == "Admin")
                {
                    ...
                    try
                    {
                        ...
                        NameUser = tendangnhapnv;
                        string salt = "QUYETDAICA1997";
                        string mkhaudangnhapnv = EncodeSHA1(txtMatKhauNVCapNhat.Text + salt);
                        Pass_Up = mkhaudangnhapnv;
                        string catruc = txtCaTrucNVCapNhat.Text;

                        // Tạo DTo
                        DTO_NhanVien up = new DTO_NhanVien(manv, tendangnhapnv, hotennv, mkhaudangnhapnv, catruc); // Vì ID tự tăng nên để ID số gì cũng dc
                        ...
                        if (nv.updateNV(up))
                        {
                            ...
                            userName.Text = busDangNhap.getNameUser_Login(NameUser, Pass_Up);
                            label1.Text = busDangNhap.getPermissionUser_Login(NameUser, Pass_Up);                                                     
        ...
        void ReadOnly_ChiTietDG() {
            ...
            dtpkCTNgayHetHanDG.Enabled = false;
        ...
        void Hide_ChiTietDG()
        {
            ...
            rdCTKhach_DG.Hide();
            rdCTSV_DG.Hide();
            lbCTNgayHetHanDG.Hide();
            dtpkCTNgayHetHanDG.Hide();
            dtkCTNgaySinhDG.Hide();
            dtpkCTNgayHetHanDG.Text = null;
        ...
        void Show_ChiTietDG()
        {
            ...
            lbCTMSCB_DG.Show();
            lbCTMSSV_DG.Show();
            lbCTNgayHetHanDG.Show();
            dtpkCTNgayHetHanDG.Show();
        ...
        private void btnXemChiTiet_Click(object sender, EventArgs e)
        {
            ...
            dtpkCTNgayHetHanDG.Text = dgvDGSearch[10, dgvDGSearch.CurrentRow.Index].Value.ToString().Trim();
            ...
            Hide_SearchChiTiet_DG();


        }
        void Hide_SearchChiTiet_DG()
        {
            rdMaDGSearch.Enabled = false;
            rdMaDinhDanhSearch.Enabled = false;
            rdHoTenSearch.Enabled = false;
            lblDinhDanhSearch.Enabled = false;
            txtSearchDG.Enabled = false;
            btnSearchDocGia.Enabled = false;
           
        }
        void Show_SearchChiTiet_DG()
        {
            rdMaDGSearch.Enabled = true;
            rdMaDinhDanhSearch.Enabled = true;
            rdHoTenSearch.Enabled = true;
            lblDinhDanhSearch.Enabled = true;
            txtSearchDG.Enabled = true;
            btnSearchDocGia.Enabled = true;
        ...
        private void btnPanelSach_Click(object sender, EventArgs e)
        {
            ...
            animator4.HideSync(Panel_Current);
            // panel2.Visible = true;           
            animator4.ShowSync(panelQLSach);
            Panel_Current = panelQLSach;
        ...
        private void btnThongKe_Click(object sender, EventArgs e)
        {
            ...
            animator4.ShowSync(pnThongKe);
            Panel_Current = pnThongKe;
        ...
        {
            //BUS_Phieu p = new BUS_Phieu();
            //cbxMaDGPM.DataSource = p.LayDanhSachMaDocGia();
        ...
        {
            string maTaiLieuCu = PT_MTL_UD.Text;
            ...
            BUS_Phieu p = new BUS_Phieu();
            p.ChinhSuaCTPhieuTra(maCTPT, maPhieuTra, maPhieuMuon, maTaiLieuCu, maTaiLieu);
                    ...
                    if (maphieumuon != maPMtemp)
                    {
                        if (mpt.LaySoSachCuaPM(maphieumuon) > lbDanhSachSachTra.Items.Count)
                        {
                            if (mpt.LaySoLanViPhamCuaPhieuMuon(maphieumuon) >= 0 && mpt.LaySoLanViPhamCuaPhieuMuon(maphieumuon) < 2)
                            {
                                ...
                                if (MessageBox.Show(string.Format("Lập Phiếu Trả Thành Công \nCó Lập Phiểu Nhắc Nhở Cho Phiếu Mượn " + maphieumuon + " Không?"), "Độc Giả Trả Sách Không Đủ", MessageBoxButtons.YesNo) == DialogResult.Yes)
                                {
                            ...
                            {
                                if (MessageBox.Show(string.Format("Lập Phiếu Trả Thành Công \nCó Lập Phiểu Phạt Cho Phiếu Mượn " + maphieumuon + " Không?"), "Độc Giả Trả Sách Không Đủ", MessageBoxButtons.YesNo) == DialogResult.Yes)
                                {
                        ...
                        else if (mpt.LaySoNgayQuaHan(maphieumuon) > 0)
                        {
                            ...
                            if (mpt.LaySoLanViPhamCuaPhieuMuon(maphieumuon) >= 0 && mpt.LaySoLanViPhamCuaPhieuMuon(maphieumuon) < 2)
                            {
                                if (MessageBox.Show(string.Format("Lập Phiếu Trả Thành Công \nCó Lập Phiểu Nhắc Nhở Cho Phiếu Mượn " + maphieumuon + " Không?"), "Độc Giả Trả Sách Quá Hạn", MessageBoxButtons.YesNo) == DialogResult.Yes)
                                {
                                    cbxmaDocGiaNN.Visible = true;
                                    cbxmaDocGiaNN.Text = mpt.LayMaDocGiaDePhat(maphieumuon).Trim();
                                    tbcQuanLiPhieu.SelectedTab = tbcQuanLiPhieu.TabPages[3];
                                    lag = 1;
                                }
                            }
                            ...
                            if (mpt.LaySoLanViPhamCuaPhieuMuon(maphieumuon) >= 2 && mpt.LaySoLanViPhamCuaPhieuMuon(maphieumuon) < 5)
                            {
                                if (MessageBox.Show(string.Format("Lập Phiếu Trả Thành Công \nCó Lập Phiểu Phạt Cho Phiếu Mượn " + maphieumuon + " Không?"), "Độc Giả Trả Sách Quá Hạn", MessageBoxButtons.YesNo) == DialogResult.Yes)
                                {
                                    cbxMaPMcuaPP.Visible = true;
                                    lbMaPM_PP.Visible = true;
                                    cbxMaPMcuaPP.Text = maphieumuon;
        ...
        //sao???? show thành công trước khi chuyển tab đấy...sao có lần vào if đc lần không, là cờ nó = 0 thì v á
        ...
        private void btnAddMTLVaoList_Click(object sender, EventArgs e)
        {
            ...
            if ((p.SoSachDangMuon(maDocGia) + lbListSachMuon.Items.Count) < p.SoSachMuonToiDa(maDocGia))
            {
                ...
                {
                    lbListSachMuon.Items.Add(cbxMaTLPM.Text.Trim());
                    lbListSachMuonHide.Items.Add(cbxMaTLPM.SelectedValue.ToString().Trim());
                }
        ...
        private void btn_LapPhieuPhat_Click(object sender, EventArgs e)
        {
            ...
            {
                string maphieumuon = cbxMaPMcuaPP.Text.ToString();
        ...
        */
        ...
        private void btnBaoCaoThongKe_Click(object sender, EventArgs e)
        {
            ...
            animator4.HideSync(Panel_Current);
            animator4.ShowSync(panelReport);
            Panel_Current = panelReport;
        ...
        {
            if (cryReportViewer.ReportSource == null)
            {
        ...
        */
        private void btnQuanTriAdmin_Click(object sender, EventArgs e)
        {
            ...
            animator4.HideSync(Panel_Current);
            Panel_Current = panelQuanTriAdmin;
            animator4.ShowSync(panelQuanTriAdmin);
        ...
        {
            lbMaTaiLieuPhieuMuon.Text = cbxMaTLPM.SelectedValue.ToString().Trim();
        }
        ...
        private void dgvPhieuTra_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            PT_MTL_UD.Text = dgvPhieuTra[3, dgvPhieuTra.CurrentRow.Index].Value.ToString().Trim();
        }
        ...
        {
            if (txtPassNVDangKy.TextLength < 8)
            {
                MessageBox.Show("Mật khẩu Phải Đủ 8 Ký Tự Trở Lên !");
                return;
            }
            if (txtPassNVDangKy.Text != txtConfirmPass.Text)
            {
                MessageBox.Show("Xác Nhận Mật khẩu Không Đúng!!!", "Lỗi Xác Nhận Mật Khẩu",MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            if (txtHoTenNVDangKy.Text != "" && txtUserNVDangKy.Text != "" && txtPassNVDangKy.Text != "")
            {
                ...
                else
                {
                    ...
                    txtHoTenNVDangKy = null;
                    txtUserNVDangKy = null;
                    txtPassNVDangKy = null;
                    txtCaNVDangKy = null;
                    txtConfirmPass = null;
                    txtMaNVDangKy.Text = busDangKy.TimNhanVienTiepTheo();
                }  
